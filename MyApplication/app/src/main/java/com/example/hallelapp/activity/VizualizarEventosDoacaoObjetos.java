...
public class VizualizarEventosDoacaoObjetos extends AppCompatActivity {
    ...
    private void recicleView(List<AllEventosListResponse> responseEventos) {
        ...
        recycle.setOnItemClickListener(new EventosRecycle.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(VizualizarEventosDoacaoObjetos.this, ListDoacaoObjetosAlimentos.class);
