...
public class UserListDoacaoDinheiro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TableLayout tableLayout = findViewById(R.id.tableLayoutDoacaoDinheiro2);
        Button btnAZ = findViewById(R.id.btnAzDinheiro2);
        Button btnZA = findViewById(R.id.btnZaDinheiro2);
        Button btnValor = findViewById(R.id.btnValor2);
        Button btnOrdemCronologica = findViewById(R.id.btnOrdemCronologicaDinheiro2);
