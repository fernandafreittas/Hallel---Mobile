...
public class VizualizarEventosVoluntario extends AppCompatActivity {
    ...
    private void recicleView(List<AllEventosListResponse> responseEventos) {
        ...
        recycle.setOnItemClickListener(new EventosRecycle.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(VizualizarEventosVoluntario.this, ListVoluntariosEventoActivity.class);
